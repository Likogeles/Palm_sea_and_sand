...
API_TOKEN = "6373726278:AAEHzQ4fbhWHHyvMb1oPH9JfdzDhS2bIHlE"
bot = Bot(API_TOKEN)
...
#async def start_form(message: types.Message):
    #btn1 = InlineKeyboardButton(text="кино", callback_data="answer_cinema")
    #btn2 = InlineKeyboardButton(text="театр", callback_data="answer_theatre")
    #keyboard_inline = InlineKeyboardMarkup().add(btn1, btn2)
    #await message.answer("Тебе нравится кино или театр?", reply_markup=keyboard_inline)
...
async def resume_question(call: types.CallbackQuery):
    ...
    # Тебе нравится история?
        ...
        #keyboard_inline.add(btn4)
        #keyboard_inline.add(btn5)
        await call.message.answer("Сколько тебе лет?", reply_markup=keyboard_inline)

    if call.data == "teenage" or call.data == "young" or call.data == "adult": #or call.data == "aged" or call.data == "ancient":
